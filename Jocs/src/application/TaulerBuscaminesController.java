...
public class TaulerBuscaminesController {
	...
	public void partidaGuanyada() {
		...
		guardarRecord(username, temps, nivell);
	}
	...
	public void guardarRecord(String username, int temps, String nivell) {
		try {
			...
			System.out.println("Record guardat per a l'usuari " + username + ", temps: " + temps + ", nivell: " + nivell);
